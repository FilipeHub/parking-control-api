...
public class ParkingSpotController {
    ...
    @GetMapping
    public ResponseEntity<Page<ParkingSpotModel>> getAllParkingSpot(@PageableDefault(page = 0, size = 3, sort = "id", direction = Sort.Direction.ASC)
                                                                    Pageable pageable){
    ...
    public ResponseEntity<Object> getOneParkingSpot(@PathVariable(value = "id") UUID id){
        ...
        return ResponseEntity.status(HttpStatus.FOUND).body(parkingSpotModelOptional.get());
    }
    ...
    public ResponseEntity<Object> deleteParkingSpot(@PathVariable(value = "id")UUID id){
        ...
        return ResponseEntity.status(HttpStatus.OK).body("Parking Spot deleted with success!");
    }
    ...
    public ResponseEntity<Object> updateParkingSpot(@PathVariable(value = "id")UUID id,
        ...
        parkinSpotModel.setRegistrationDate(parkingSpotModelOptional.get().getRegistrationDate());
